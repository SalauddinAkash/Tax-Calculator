...
<body>
    ...
    <div class="login-box">
        <form action="addt.php" method="post">
            ...
            <div class="text-box">
                <input required="required" type="text" placeholder="TAX ID" name="tid">
            </div>

            <div class="text-box">
                <input required="required" type="double" placeholder="Amount" name="t">
            </div>
